...
//PengNan@BSP.CHG.Vooc, 2018/02/28, add for vooc fw update.
	...
	int vooc_strategy1_batt_up_down_temp1;
	int vooc_strategy1_batt_up_down_temp2;
	int vooc_strategy1_batt_up_temp3;
	int vooc_strategy1_batt_up_temp4;
	int vooc_strategy1_batt_up_temp5;
	int vooc_strategy1_high0_current;
	int vooc_strategy1_high1_current;
	int vooc_strategy1_high2_current;
