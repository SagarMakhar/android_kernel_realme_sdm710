...
static int apps_monitor_netlink_nlmsg_handle(struct sk_buff *skb, struct nlmsghdr *nlh)
{
	int ret = 0;
...
{
	init_timer(&apps_monitor_timer);
	apps_monitor_timer.function = (void*)apps_monitor_timer_function;
